/*
 * GRCNNWordCharClassifier.h
 *
 *  Created on: Mar 18, 2015
 *      Author: mszhang
 */

#ifndef SRC_GRCNNWordCharClassifier_H_
#define SRC_GRCNNWordCharClassifier_H_
...
public:
  ...
  inline dtype process(const vector<Example>& examples, int iter) {
    ...
    for (int count = 0; count < example_num; count++) {
      ...
      Tensor<xpu, 3, dtype> char_rnn_hidden_left_update[word_num];
      Tensor<xpu, 3, dtype> char_rnn_hidden_left_reset[word_num];
      Tensor<xpu, 3, dtype> char_rnn_hidden_left[word_num], char_rnn_hidden_leftLoss[word_num];
      Tensor<xpu, 3, dtype> char_rnn_hidden_left_afterreset[word_num];
      Tensor<xpu, 3, dtype> char_rnn_hidden_left_current[word_num];

      Tensor<xpu, 3, dtype> char_rnn_hidden_right_update[word_num];
      Tensor<xpu, 3, dtype> char_rnn_hidden_right_reset[word_num];
      Tensor<xpu, 3, dtype> char_rnn_hidden_right[word_num], char_rnn_hidden_rightLoss[word_num];
      Tensor<xpu, 3, dtype> char_rnn_hidden_right_afterreset[word_num];
      Tensor<xpu, 3, dtype> char_rnn_hidden_right_current[word_num];
...

      {
        ...
        for (int idy = 0; idy < word_num; idy++) {
          ...
          char_rnn_hidden_left_reset[idy] = NewTensor<xpu>(Shape3(char_num, 1, _charHiddenSize), d_zero);
          char_rnn_hidden_left_update[idy] = NewTensor<xpu>(Shape3(char_num, 1, _charHiddenSize), d_zero);
          char_rnn_hidden_left_afterreset[idy] = NewTensor<xpu>(Shape3(char_num, 1, _charHiddenSize), d_zero);
          char_rnn_hidden_left_current[idy] = NewTensor<xpu>(Shape3(char_num, 1, _charHiddenSize), d_zero);
          char_rnn_hidden_left[idy] = NewTensor<xpu>(Shape3(char_num, 1, _charHiddenSize), d_zero);
          char_rnn_hidden_leftLoss[idy] = NewTensor<xpu>(Shape3(char_num, 1, _charHiddenSize), d_zero);

          char_rnn_hidden_right_reset[idy] = NewTensor<xpu>(Shape3(char_num, 1, _charHiddenSize), d_zero);
          char_rnn_hidden_right_update[idy] = NewTensor<xpu>(Shape3(char_num, 1, _charHiddenSize), d_zero);
          char_rnn_hidden_right_afterreset[idy] = NewTensor<xpu>(Shape3(char_num, 1, _charHiddenSize), d_zero);
          char_rnn_hidden_right_current[idy] = NewTensor<xpu>(Shape3(char_num, 1, _charHiddenSize), d_zero);
          char_rnn_hidden_right[idy] = NewTensor<xpu>(Shape3(char_num, 1, _charHiddenSize), d_zero);
          char_rnn_hidden_rightLoss[idy] = NewTensor<xpu>(Shape3(char_num, 1, _charHiddenSize), d_zero);

          char_midhidden[idy] = NewTensor<xpu>(Shape3(char_num, 1, 2 * _charHiddenSize), d_zero);
          char_midhiddenLoss[idy] = NewTensor<xpu>(Shape3(char_num, 1, 2 * _charHiddenSize), d_zero);
      ...
      //input setting, and linear setting
      {
        ...
        //char RNN
        for (int idy = 0; idy < word_num; idy++) {
          _char_rnn_left.ComputeForwardScore(char_input[idy], char_rnn_hidden_left_reset[idy], char_rnn_hidden_left_afterreset[idy],
              char_rnn_hidden_left_update[idy], char_rnn_hidden_left_current[idy], char_rnn_hidden_left[idy]);
          _char_rnn_right.ComputeForwardScore(char_input[idy], char_rnn_hidden_right_reset[idy], char_rnn_hidden_right_afterreset[idy],
              char_rnn_hidden_right_update[idy], char_rnn_hidden_right_current[idy], char_rnn_hidden_right[idy]);
        }
...

      {
        ...
        _rnn_left.ComputeBackwardLoss(input, rnn_hidden_left_reset, rnn_hidden_left_afterreset, rnn_hidden_left_update, rnn_hidden_left_current,
            rnn_hidden_left, rnn_hidden_leftLoss, inputLoss);
        _rnn_right.ComputeBackwardLoss(input, rnn_hidden_right_reset, rnn_hidden_right_afterreset, rnn_hidden_right_update, rnn_hidden_right_current,
        ...
        for (int idy = 0; idy < word_num; idy++) {
          _char_rnn_left.ComputeBackwardLoss(char_input[idy], char_rnn_hidden_left_reset[idy], char_rnn_hidden_left_afterreset[idy],
              char_rnn_hidden_left_update[idy], char_rnn_hidden_left_current[idy], char_rnn_hidden_left[idy], char_rnn_hidden_leftLoss[idy],
              char_inputLoss[idy]);
          _char_rnn_right.ComputeBackwardLoss(char_input[idy], char_rnn_hidden_right_reset[idy], char_rnn_hidden_right_afterreset[idy],
              char_rnn_hidden_right_update[idy], char_rnn_hidden_right_current[idy], char_rnn_hidden_right[idy], char_rnn_hidden_rightLoss[idy],
              char_inputLoss[idy]);
        }
      ...
      //release
      {
        ...
        for (int idy = 0; idy < word_num; idy++) {
          ...
          FreeSpace(&(char_rnn_hidden_left_reset[idy]));
          FreeSpace(&(char_rnn_hidden_left_update[idy]));
          FreeSpace(&(char_rnn_hidden_left_afterreset[idy]));
          FreeSpace(&(char_rnn_hidden_left_current[idy]));
          FreeSpace(&(char_rnn_hidden_left[idy]));
          FreeSpace(&(char_rnn_hidden_leftLoss[idy]));

          FreeSpace(&(char_rnn_hidden_right_reset[idy]));
          FreeSpace(&(char_rnn_hidden_right_update[idy]));
          FreeSpace(&(char_rnn_hidden_right_afterreset[idy]));
          FreeSpace(&(char_rnn_hidden_right_current[idy]));
...
#endif /* SRC_GRCNNWordCharClassifier_H_ */
