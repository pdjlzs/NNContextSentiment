...
public:
  ...
  inline dtype process(const vector<Example>& examples, int iter) {
    ...
    for (int count = 0; count < example_num; count++) {
      ...
      Tensor<xpu, 3, dtype> rnn_hidden_left_i;
      Tensor<xpu, 3, dtype> rnn_hidden_left_o;
      Tensor<xpu, 3, dtype> rnn_hidden_left_f;
      Tensor<xpu, 3, dtype> rnn_hidden_left_mc;
      Tensor<xpu, 3, dtype> rnn_hidden_left_c;
      Tensor<xpu, 3, dtype> rnn_hidden_left_my;
      Tensor<xpu, 3, dtype> rnn_hidden_left, rnn_hidden_leftLoss;

      Tensor<xpu, 3, dtype> rnn_hidden_right_i;
      Tensor<xpu, 3, dtype> rnn_hidden_right_o;
      Tensor<xpu, 3, dtype> rnn_hidden_right_f;
      Tensor<xpu, 3, dtype> rnn_hidden_right_mc;
      Tensor<xpu, 3, dtype> rnn_hidden_right_c;
      Tensor<xpu, 3, dtype> rnn_hidden_right_my;
...

      {
        ...
        rnn_hidden_left_i = NewTensor<xpu>(Shape3(word_num, 1, _wordHiddenSize), d_zero);
        rnn_hidden_left_o = NewTensor<xpu>(Shape3(word_num, 1, _wordHiddenSize), d_zero);
        rnn_hidden_left_f = NewTensor<xpu>(Shape3(word_num, 1, _wordHiddenSize), d_zero);
        rnn_hidden_left_mc = NewTensor<xpu>(Shape3(word_num, 1, _wordHiddenSize), d_zero);
        rnn_hidden_left_c = NewTensor<xpu>(Shape3(word_num, 1, _wordHiddenSize), d_zero);
        rnn_hidden_left_my = NewTensor<xpu>(Shape3(word_num, 1, _wordHiddenSize), d_zero);
        ...
        rnn_hidden_right_i = NewTensor<xpu>(Shape3(word_num, 1, _wordHiddenSize), d_zero);
        rnn_hidden_right_o = NewTensor<xpu>(Shape3(word_num, 1, _wordHiddenSize), d_zero);
        rnn_hidden_right_f = NewTensor<xpu>(Shape3(word_num, 1, _wordHiddenSize), d_zero);
        rnn_hidden_right_mc = NewTensor<xpu>(Shape3(word_num, 1, _wordHiddenSize), d_zero);
        rnn_hidden_right_c = NewTensor<xpu>(Shape3(word_num, 1, _wordHiddenSize), d_zero);
        rnn_hidden_right_my = NewTensor<xpu>(Shape3(word_num, 1, _wordHiddenSize), d_zero);
      ...
      //input setting, and linear setting
      {
        ...
        _rnn_left.ComputeForwardScore(input, rnn_hidden_left_i, rnn_hidden_left_o, rnn_hidden_left_f, rnn_hidden_left_mc, rnn_hidden_left_c, rnn_hidden_left_my,
            rnn_hidden_left);
        _rnn_right.ComputeForwardScore(input, rnn_hidden_right_i, rnn_hidden_right_o, rnn_hidden_right_f, rnn_hidden_right_mc, rnn_hidden_right_c,
            rnn_hidden_right_my, rnn_hidden_right);
...

      {
        ...
        _rnn_left.ComputeBackwardLoss(input, rnn_hidden_left_i, rnn_hidden_left_o, rnn_hidden_left_f, rnn_hidden_left_mc, rnn_hidden_left_c, rnn_hidden_left_my,
            rnn_hidden_left, rnn_hidden_leftLoss, inputLoss);
        _rnn_right.ComputeBackwardLoss(input, rnn_hidden_right_i, rnn_hidden_right_o, rnn_hidden_right_f, rnn_hidden_right_mc, rnn_hidden_right_c,
            rnn_hidden_right_my, rnn_hidden_right, rnn_hidden_rightLoss, inputLoss);
      ...
      FreeSpace(&rnn_hidden_left_i);
      FreeSpace(&rnn_hidden_left_o);
      FreeSpace(&rnn_hidden_left_f);
      FreeSpace(&rnn_hidden_left_mc);
      FreeSpace(&rnn_hidden_left_c);
      FreeSpace(&rnn_hidden_left_my);
      FreeSpace(&rnn_hidden_left);
      FreeSpace(&rnn_hidden_leftLoss);

      FreeSpace(&rnn_hidden_right_i);
      FreeSpace(&rnn_hidden_right_o);
      FreeSpace(&rnn_hidden_right_f);
      FreeSpace(&rnn_hidden_right_mc);
      FreeSpace(&rnn_hidden_right_c);
