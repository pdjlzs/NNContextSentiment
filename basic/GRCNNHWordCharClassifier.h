/*
 * GRCNNHWordCharClassifier.h
 *
 *  Created on: Mar 18, 2015
 *      Author: mszhang
 */

#ifndef SRC_GRCNNHWordCharClassifier_H_
#define SRC_GRCNNHWordCharClassifier_H_
...
class GRCNNHWordCharClassifier {
public:
  GRCNNHWordCharClassifier() {
    _dropOut = 0.5;
  }
  ~GRCNNHWordCharClassifier() {
      ...
      for (int idx = 0; idx < seq_size; idx++) {
        ...
        for (int idy = 0; idy < word_num; idy++) {
          _char_rnn_left.ComputeBackwardLoss(char_input[idx][idy], char_rnn_hidden_left_reset[idx][idy], char_rnn_hidden_left_afterreset[idx][idy],
              char_rnn_hidden_left_update[idx][idy], char_rnn_hidden_left_current[idx][idy], char_rnn_hidden_left[idx][idy], char_rnn_hidden_leftLoss[idx][idy],
...
#endif /* SRC_GRCNNHWordCharClassifier_H_ */
